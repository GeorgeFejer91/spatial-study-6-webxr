...
`study6-bridge-v1.schema.json` and the fixture envelopes in `fixtures/` are
...
Protocol v1 is intentionally a placeholder-rehearsal contract. It carries a
bounded Polar/recording projection and privacy-minimized experiment markers. It
never carries questionnaire state, participant details, answers, raw ECG, or
exported records. WebXR—not the APK—owns all questionnaire and condition logic.
